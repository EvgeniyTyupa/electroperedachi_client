...
import Masquerade from "../../components/Pages/Events/Masquerade/Masquerade"
    ...
    return (
        <>
            <Head>
                ...
                <link href="https://fonts.googleapis.com/css2?family=Cormorant:ital,wght@0,300..700;1,300..700&family=Raleway:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet"></link>
            </Head>
            <Masquerade event={event}/>
        </>
    )
}
...
export async function getServerSideProps(context) {
    ...
    const { event } = await eventApi.getEvent("masquerade")
