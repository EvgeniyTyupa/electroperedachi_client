...
import TechnoFashion from "../../components/Pages/Events/TechnoFashion/TechnoFashion"

const TechnoFashionPage = (props) => {
    ...
    return (
        <>
            <Head>
                ...
                <link href="https://fonts.cdnfonts.com/css/helvetica-neue-55?styles=16016,16008,16020,15986,15996,15999,30133" rel="stylesheet"/>
            </Head>
            <TechnoFashion event={event}/>
        </>
    )
}
...
export async function getServerSideProps(context) {
    ...
    const { event } = await eventApi.getEvent("techno-fashion")
...
export default TechnoFashionPage
