...
import CyberChristmas from "../../components/Pages/Events/CyberChristmas/CyberChristmas"

const CyberChristmasEventPage = (props) => {
...
export async function getServerSideProps(context) {
    ...
    const { event } = await eventApi.getEvent("cyber-christmas")
...
export default CyberChristmasEventPage