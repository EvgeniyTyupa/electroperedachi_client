...
import VampireCarnival from "../../components/Pages/Events/VampireCarnival/VampireCarnival"

const VapmireCarnivalEventPage = (props) => {
...
export async function getServerSideProps(context) {
    ...
    const { event } = await eventApi.getEvent("vampire-carnival")
...
export default VapmireCarnivalEventPage