...
import ViceCity from "../../components/Pages/Events/ViceCity/ViceCity"

const ViceCityPage = (props) => {
...
export async function getServerSideProps(context) {
    ...
    const { event } = await eventApi.getEvent("vice-city")
