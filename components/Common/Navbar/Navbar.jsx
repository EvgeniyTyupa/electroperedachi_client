...
const Navbar = () => {
    ...
    return (
        <nav className={cx(
            ...
            router.pathname === "/hozho" ? classes.absolute : undefined,
            router.pathname === "/vampire-carnival" ? classes.absolute : undefined,
            router.pathname === "/cyber-christmas" ? classes.absolute : undefined,
